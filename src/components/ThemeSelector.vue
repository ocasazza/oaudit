<template>
  <div class="space-y-4">
    <div>
      ...
      <div class="relative">
        <select
          ...
          @change="changeTheme"
          class="w-full px-3 py-2 border border-secondary-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200 appearance-none bg-secondary-50 text-primary-900"
        >
          <option
    ...
    <!-- Theme Preview -->
    <div class="p-4 border border-secondary-200 rounded-md bg-secondary-50/50">
