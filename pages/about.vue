<template>
  <div class="bg-gradient-to-br from-primary-50 to-secondary-100 transition-colors duration-300 min-h-full">
    <div class="container mx-auto px-4 py-8">
        ...
        <p class="text-xl text-secondary-600 transition-colors duration-300">
          A vue.js application used to expose the oaudit cli tool. This UI allows a user to audit okta applications and users.
        </p>
